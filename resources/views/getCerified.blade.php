    ...
    <div class="main-wrapper">
        ...
        @endif
                            ...
                            <div class="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden p-lg-4 p-2">
                                <div class="card-body mb-lg-3 pb-0"><h2 class="fw-400 font-lg d-block">Get <b>Rewards</b> </h2>
                                <p>Get rewarded for watching videos on curiouskidz</p></div>
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6">
                                            ...
                                            @if($cat)
                                                      @foreach($cat as $item)
                                                          <a href="/germified/allCourses/{{$item->age}}" class="btn-round-xxxl rounded-lg ml-auto mr-auto">
                                                              <img src="{{url ('uploads/category') }}/{{$item->image}}" alt="{{url ('uploads/category') }}/{{$item->image}}" class="w-100">
                                                          </a>
                                                          <h4 class="fw-700 font-xsss mt-4">{{$item->title}}
                                                            </h4>
                                                      ...
                                                      @endforeach
                                                          <h4 class="fw-700 font-md"> {{$countGamify}}  <span class="font-xsssss fw-500 mt-1 text-grey-500 d-block">courses </span></h4>

                                                            @if($getWonCheck)
                                                             <i class="ti-check font-xssss btn-round-xs bg-success text-white ml-1"></i>
                                                            @endif
                                                           
                                              @else


                                              <p>No Badge Reward yet</p>
