            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Manage Badges</h3>
                            
                        </div>
                        <div class="col-auto float-right ml-auto">
                            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i class="fa fa-plus"></i> Add Badge</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table datatable">
                                ...
                                @foreach($getBadges as $item)

                                    <tr>

                                    <td><img src="/uploads/badges/{{$item->image}}" height="80" width="80"></td>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <!--<a class="dropdown-item" href="/admin/category/{{$item->id}}/edit"><i class="fa fa-eyes-o m-r-5"></i> Edit</a>-->
                                                
                                                    <a class="dropdown-item" onclick="return confirm('Are you sure?')" href="/admin/badge/{{$item->id}}/delete"><i class="fa fa-trash-o m-r-5"></i> Trash</a>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
