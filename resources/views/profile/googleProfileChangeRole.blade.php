        ...
        <nav class="navigation scroll-bar">
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    <div class="nav-top">
                         <a data-toggle="modal" data-target="#check"><h1 class="fredoka-font ls-3 fw-700 text-current font-xxl">CuriousKidz <span class="d-block font-xsssss ls-1 text-grey-500 open-font ">Online Learning Course</span></h1></a>
                         
                         
                       
                        <a data-toggle="modal" data-target="#check" class="close-nav d-inline-block d-lg-none"><i class="ti-close bg-grey mb-4 btn-round-sm font-xssss fw-700 text-dark ml-auto mr-2 "></i></a>
                    </div>
                    <br>
                    ...
                    <ul class="mb-3">
                        ...
                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/1913/1913812.png" width="30" height="30"><span>&nbsp;&nbsp;Academic Library</span></a></li> 
                        
                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/2997/2997592.png" width="30" height="30"><span>&nbsp;&nbsp;Edutainment Library</span></a></li> 
                        
                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/5765/5765355.png" width="30" height="30"><span>&nbsp;&nbsp;Saved Course</span></a></li>

                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/8180/8180239.png" width="30" height="30"><span>&nbsp;&nbsp;Get Rewarded</span></a></li> 

                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/3227/3227076.png" width="30" height="30"><span>&nbsp;&nbsp;My Badges</span></a></li> 
                          
                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check"  class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/9131/9131590.png" width="30" height="30"><span>&nbsp;&nbsp;My Profile</span></a></li> 
                       
                        <li class="flex-lg-brackets"><a data-toggle="modal" data-target="#check" data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/9149/9149046.png" width="30" height="30"><span>&nbsp;&nbsp;Contact Us</span></a></li>                  
                    </ul>
            ...
            <div class="middle-sidebar-header bg-white">
                ...
                <ul class="d-flex ml-auto right-menu-icon">
                    ...
                    &nbsp;&nbsp;&nbsp;
                            ...
                            <a data-toggle="modal" data-target="#check"><img src="{{ url('auth/cdn/img/profiles/avatar.png') }}" width="32" height="32">
                              {{Auth::user()->name}}
                            </a>
                ...
                <div class="card-body p-lg-5 p-4 bg-black-08">
                            ...
                            <div class="col-lg-12 pl-xl-5 pt-xl-5">
                                ...
                                <div class="col-xl-4 col-lg-6 pl-xl-5 pb-xl-5 pb-3">
                                    ...
                                    <h4 class="fw-700 font-md text-white mt-3 mb-1">{{Auth::user()->name}} <i class="ti-check font-xssss btn-round-xs bg-success text-white ml-1"></i></h4>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Update Profile Type</h1>
                                        <small>Note, all button selections are disabled until you complete your profile.</small>
										<!--end::Title-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
                                        ...
                                        <form class="form" enctype="multipart/form-data" method="POST" action="/updateGoogleAccountType/{{Auth::user()->id}} ">
                                                            @csrf
                                                                    ...
                                                                    <div class="row mb-6">
                                                                <!--begin::Label-->
                                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Account Type *</label>
                                                                <!--end::Label-->
                                                                <!--begin::Col-->
                                                                <div class="col-lg-8 fv-row">
                                                                    <select name="roles" class="form-control form-control-lg form-control-solid">
                                                                ...
                                                                <br>
                                                                  ...
                                                                  <div class="row mb-6">
                                                                <!--begin::Label-->
                                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Age Group</label>
                                                                <!--end::Label-->
                                                                <!--begin::Col-->
                                                                <div class="col-lg-8 fv-row">
                                                                ...
                                                                <br>
                                                                    ...
                                                                    <div class="row mb-6">
                                                                <!--begin::Label-->
                                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Academic Class</label>
                                                                <!--end::Label-->
                                                                <!--begin::Col-->
                                                                <div class="col-lg-8 fv-row">
                                                                ...
                                                                <!--end::Input group-->
                                                                 ...
                                                                 <div class="row mb-6">
                                                                    <!--begin::Label-->
                                                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Create a New Password *</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-8 fv-row">
                                                                        <input type="password" required class="form-control form-control-lg form-control-solid" placeholder="Enter your password"  />
                                                                    </div>
                                                                    <!--end::Col-->
                                                                </div>
                                                                <!--end::Input group-->
