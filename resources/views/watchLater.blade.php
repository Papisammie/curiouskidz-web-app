    ...
    <div class="main-wrapper">
        ...
        @endif
                        ...
                        <div class="col-lg-12 pt-4 mb-3">
                            <h2 class="fw-400 font-lg d-block">Saved <b> Video</b></h2>
                        </div>
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        <div class="card-image w-100 mb-3">
                                            <a href="/course/details/{{$item->course_id}}" class="video-bttn position-relative d-block"><img src="/uploads/course/{{$item->image}}" alt="image" class="w-100"></a>
                                        </div>
