    ...
    <div class="main-wrapper">
            ...
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    ...
                    <ul class="mb-3">
                        ...
                        <!-- <li class="flex-lg-brackets"><a href="/login" data-tab="archived" class="p-0 btn p-2 lh-24 w100 ml-1 ls-3 d-inline-block btn-success font-xsssss fw-700 ls-lg text-white"><span>Login</span></a>
                        </li>   
                        
                        
                        <li class="flex-lg-brackets"><a href="/register" data-tab="archived" class="p-0 btn p-2 lh-24 w100 ml-1 ls-3 d-inline-block bg-current font-xsssss fw-700 ls-lg text-white"><span>Join for free</span></a>
                        </li>    -->
                        ...
                        <li class="flex-lg-brackets"><a href="/getCertify/watchCourses/{{Auth::user()->class}}" data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/8180/8180239.png" width="30" height="30"><span>&nbsp;&nbsp;Get Rewarded</span></a></li> 
                        ...
                        <li class="flex-lg-brackets"><a href="/about/curiousKidz" data-tab="archived" class="nav-content-bttn open-font"><img src="https://cdn-icons-png.flaticon.com/512/3815/3815523.png" width="30" height="30"><span>&nbsp;&nbsp;About CuriousKidz</span></a></li>   
                    </ul>
        ...
        <div class="main-content">
            ...
            <div class="middle-sidebar-header bg-white">
                ...
                <li><a href="/register" data-tab="archived" class="p-0 btn p-2 lh-24 w100 ml-1 ls-3 d-inline-block rounded-xl bg-current font-xsssss fw-700 ls-lg text-white"><span>Register</span></a>
                </li>   
                
                
                <li><a href="/login" data-tab="archived" class="p-0 btn p-2 lh-24 w100 ml-1 ls-3 d-inline-block rounded-xl btn-success font-xsssss fw-700 ls-lg text-white"><span>Login</span></a>
                </li>   
                ...
                <li>
                    <form method="POST" action="{{ url('login') }}">
                        <input type="hidden" name="roles" value="guest">
                         @csrf
                        <button type="submit" class="p-0 btn p-2 lh-24 w100 rounded-xl btn-secondary font-xsssss fw-700 ls-lg text-white"><span>Login as Guest</span>
                        </button>
                    </form>
                </li>   
                    ...
                    @if(Auth::user()->roles == "student")
                        ...
                        @endif
                         ...
                         @if(Auth::user()->roles == "guest")
                          ...
                          @else
                          <a href="/profile/{{Auth::user()->id}}"><img src="/uploads/profilePicture/{{Auth::user()->avatar}}" width="25" height="25">
                          &nbsp;{{Auth::user()->name}}
                            </a>
